...
#' @value Writes to path a csv file with the DrugExposureDiagnostics summary results
#' @export
...
#' @value Writes to outputFolder a csv file with the DrugExposureDiagnostics summary results
#' @export
